...
# Term Frequency: (No of times word present in a given sentence/Total no of sentences in the given sentence)
# Inverse Document Frequency: log(No of sentences in given corpus/No of sentences containing the particular word)

# Finally we are going to multiply (TF*IDF) and forms our vector
# By this means we are giving importance to particular word in a given sentence
...
cv = TfidfVectorizer(max_features=100) # max_features helps us to select the most important features
