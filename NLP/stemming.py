# -*- coding: utf-8 -*-
"""
Created on Sun May 24 13:04:56 2020
...
sentences = sent_tokenize(paragraph) # returns list

ps = PorterStemmer() # initializing stemming object

new_sentences = [] 
for i in range(len(sentences)):
    words = word_tokenize(sentences[i])
    # returns base word either it is meaningful or not
